...
GO
ALTER TABLE [sales].[staffs] ADD CONSTRAINT [PK__staffs__1963DD9CD02E29AC] PRIMARY KEY CLUSTERED ([staff_id]) ON [PRIMARY]
GO
ALTER TABLE [sales].[staffs] ADD CONSTRAINT [UQ__staffs__AB6E6164B6687352] UNIQUE NONCLUSTERED ([email]) ON [PRIMARY]
GO
